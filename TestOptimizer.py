...
'''    
    for i in range(1,len(vertices) - 1):
        ...
        resource_vector = func(variable_vector)
        while True:
            if abs(resource_vector[0] - previous_resource_vector[0]) < allowable_error:
                break
            else:
                
                variable_vector = variable_vector - search_axis*(func(variable_vector)[0]) * np.linalg.norm(variable_vector - previous_variable_vector)/(func(variable_vector)[0] - func(previous_variable_vector)[0])
